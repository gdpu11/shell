...
class Common
{
    ...
    */
    public static function sendEmail(){
        ...
        $smtpusermail = "gdpu11@163.com";//SMTP服务器的用户邮箱
        $smtpemailto = 'gdpu11@163.com';//发送给谁
        // $smtpemailto = $_POST['toemail'];//发送给谁
        $smtpuser = "gdpu11@163.com";//SMTP服务器的用户帐号，注：部分邮箱只需@前面的用户名
        $smtppass = "1205532111";//SMTP服务器的用户密码
        $mailtitle = 'x111xxx';//邮件主题
        // $mailcontent = "<h1>".$_POST['content']."</h1>";//邮件内容
        $mailcontent = "<h1>".'x111xxxx111xxx'."</h1>";//邮件内容
