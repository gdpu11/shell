...
class MsgTABLE extends DBConnect
{
	/** 
     * 数据源结构$_SCHEMA_ 
     * 当前数据源所对应的数据库表的简单定义 
    ...
    protected static $_SCHEMA_ = array(
        ...
        'FIELDS'=>array(
            'msg_md5'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'msg'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), // 消息
            'reply_msg'=>array( 'type'=>'text', 'isAllowNull'=>true, 'defaultValue'=>'', ), // 要回复的消息
            'add_time'=>array( 'type'=>'int', 'isAllowNull'=>true, 'defaultValue'=>'', ), // 时间戳
            'last_time'=>array( 'type'=>'int', 'isAllowNull'=>true, 'defaultValue'=>'', ), // 时间戳
        ),
    );
