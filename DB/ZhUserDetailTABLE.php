...
class ZhUserDetailTABLE extends PdoOperateBase
{
  /** 
     * 数据源结构$_SCHEMA_ 
     * 当前数据源所对应的数据库表的简单定义 
    ...
    protected static $_SCHEMA_ = array(
        'TABLENAME'=>'zh_user_detail',
        'PRIMARY'=>'urlToken',//主键索引
        'FIELDS'=>array(
            'urlToken'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'id'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'avatarUrl'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'headline'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'name'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'articlesCount'=>array( 'type'=>'int', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'answerCount'=>array( 'type'=>'int', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
            'userType'=>array( 'type'=>'varchar', 'isAllowNull'=>true, 'defaultValue'=>'', ), //消息md5
        ),
    );
